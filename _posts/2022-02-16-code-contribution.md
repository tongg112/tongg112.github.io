...
学习 Angular、Vue 等成熟前端框架 的 git commit 的提交规范
...
有关详情，可以参考[英语标题大小写](https://headlinecapitalization.com/)。

## 发布管理

egg 基于 [semver](https://semver.org/lang/zh-CN/) 语义化版本号进行发布。
...
- 建立 milestone，确认需求关联 milestone，指派和更新 issues，如 [1.x milestone](https://github.com/eggjs/egg/milestone/1)。
...
- 发起一个新的 [Release Proposal MR](https://github.com/nodejs/node/pull/4181)，按照 [node CHANGELOG](https://github.com/nodejs/node/blob/master/CHANGELOG.md) 进行 `History` 的编写，修正文档中与版本相关的内容，commits 可以自动生成。
...
| style    | 修改代码格式（空格、缩进等），不影响代码逻辑           |
| refactor | 重构代码，理论上不影响现有功能，没有新功能或bug        |
| perf     | 优化相关，性能提升                                     |
| test     | 增加修改测试用例                                       |
| chore    | 修改工具相关（包括但不限于文档、代码生成等）           |
| deps     | 升级依赖                                               |
...
## 参考资料
- [【原文】Egg JS 代码贡献规范](https://www.eggjs.org/zh-CN/community/contributing)
